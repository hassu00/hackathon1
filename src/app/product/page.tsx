...
export default function Product() {
  ...
  return (
    <div>
      <Header/>
      <div className='grid lg:grid-rows-1 w-[1440px] h-[209px]'>
      Frame 143
      <Image
            width={1440}
            height={209}
      ...
      <div className="grid grid-rows-1  h-[64px] w-[1440px] ">
        <div className='flex items-center justify-between'>

        <div className='items-center flex  gap-3'>
        <select id="country" name="country" className='w-[137px] h-[48px] text-center text-[16px] font-normal leading-[24px] text-[#2A254B]'>
      ...
      <div className="grid lg:grid-rows-3  h-[510px] w-[1440px] ">
      ...
      <div className="grid lg:grid-rows-3  h-[510pxpx] w-[1440px] ">
      ...
      <div className="grid lg:grid-rows-4  h-[636px] w-[1440px] ">
        <div className="grid row-span-3 lg:grid-cols-4 items-center pl-[40px]">
          <div className="w-[305px] h-[462px] gap-[24px] bg-white cursor-pointer hover:scale-[1.05]">
            <Image
              src="/images/Parent.svg"
